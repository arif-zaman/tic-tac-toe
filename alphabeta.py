...
class Move(alphaBeta):
	def __init__(self):
		alphaBeta.__init__(self)
	...
	def makeMove(self, state):
		...
		possibleBoards.sort(key = lambda tempBoard: tempBoard[1]) # Sort 2D Array
...
if __name__ == "__main__" :
	count,moveCount,nodeCount = 0,0,0
	leave = False
	...
	while True:
		...
		pygame.display.set_caption("Tic Tac Toe - 1005031")
		...
		print "\tTotal Move Taken  = %d" % moveCount
		print "\tTotal Node Search = %d" % nodeCount
		print
